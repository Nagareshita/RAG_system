...
from ....pdf.pymupdf4llm.models import ProcessedDocument, DocumentChunk
...
class ChunkDetailViewer(QWidget):
    ...
    def display_chunks(self, chunks: List[DocumentChunk]):
        ...
        for i, chunk in enumerate(chunks):
            ...
            formula_item = QTableWidgetItem("あり" if metadata.contains_formulas else "なし")
...
class ResultViewer(QTabWidget):
    ...
    def _create_save_tab(self):
        ...
        save_layout.addWidget(self.save_markdown_btn)
