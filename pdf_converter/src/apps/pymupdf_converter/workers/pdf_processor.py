...
from ....pdf.pymupdf4llm.processor import PyMuPDFProcessor
from ....pdf.pymupdf4llm.models import ProcessingSettings, ProcessedDocument
...
class PDFProcessorWorker(QThread):
    ...
    def __init__(self, settings: dict):
        ...
        self.processing_settings = ProcessingSettings(
            ...
            include_formulas=settings.get('include_formulas', True)
        )
