# Test case functional validation script, used after the __main__ function to compute pass_f@k.
import os
import re
import json
import numpy as np
...
def interpolate_to_length(data, target_length):
    x_original = np.linspace(0, 1, len(data))  # Points of raw data
    x_target = np.linspace(0, 1, target_length)  # Target point
...
if __name__ == "__main__":
    ...
    for n in range(1, 128):
        ...
        reference_csv_path = os.path.join(reference_csv_dir, matching_files[0])  
