...
from tabs.ast_validator.modelica_parser_loader import new_parser
from tabs.ast_validator.modelica_models import (
    SymbolRecord,
    CodeSpan,
    EquationBlock,
    Parameter,
...
from tabs.ast_validator.utils_text import file_bytes, sha1_text
